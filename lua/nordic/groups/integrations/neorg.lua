...
return {
    ...
    ["@neorg.headings.5.title"] = { fg = C.magenta.base, italic = true },
    ["@neorg.headings.6.title"] = { fg = C.orange.dim, italic = true },
    ...
    ["@neorg.links.location.heading.5"] = { fg = C.magenta.base, italic = true },
    ["@neorg.links.location.heading.6"] = { fg = C.orange.base, italic = true },
